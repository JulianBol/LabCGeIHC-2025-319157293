...
int main()
{
	...
	CrearCono(25, 2.0f);//índice 5 en MeshList
	CreateShaders();
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.421f, 1.0f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[3]->RenderMeshGeometry();

		// INICIAMOS CREACION DE 4 LLANTAS 

		// ARTICULACION LLANTA 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.8f, -0.65f, 2.3f));
		...
		color = glm::vec3(0.421f, 0.233f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// SE EMPIEZA EL DIBUJO DEL BRAZO (3 PARTES)
		...
		color = glm::vec3(0.690f, 0.690f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		...
		color = glm::vec3(1.0f, 0.690f, 0.690f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.75f, 3.5f, 0.75f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));

		color = glm::vec3(0.690f, 0.690f, 0.690f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		...
		// PIE
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.5f, -1.80f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.5f, 0.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// ARTICULACION 3
		model = modelroot;
		model = glm::translate(model, glm::vec3(4.25f, 0.0f, 3.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.3f, 5.0f, 1.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// CABEZA
		model = modelroot;
		model = glm::translate(model, glm::vec3(-2.0f, 2.2f, 0.0f));
		...
		// Orejas 
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.7f, 1.0f, 0.7f));
		model = glm::rotate(model, glm::radians(-5.f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
