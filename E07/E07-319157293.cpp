...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		spotLights[1].SetFlash(glm::vec3( 12.5 + mainWindow.getmuevex(), 3.5f, 6.3f), glm::vec3(1.0, -0.5, 0.0));
		...
		//Instancia del coche 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.2f, 10.0f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(12.5f, 3.0f, 6.5));
