...
void CrearDado8Caras()
{
	...
	GLfloat dado_vertices[] = {
		// x      y      z			S      T				NX      NY      NZ
		  ...
		  // frontal abajo
		  0.0f, -0.5f,   0.0f,		0.592f, 0.668f,  0.0f,  -1.0f,  0.0f,  // Pico Bajo
		 -0.5f, -0.0f,   0.5f,      0.791f, 0.336f,  0.0f,  -1.0f,  0.0f,
		  0.5f, -0.0f,   0.5f,      0.399f, 0.336f,  0.0f,  -1.0f,  0.0f,

		  // trasera abajo
		  0.0f, -0.5f,   0.0f,		0.25f, 0.5f,  0.0f,  -1.0f,  0.0f,  // Pico Bajo
		 -0.5f, -0.0f,  -0.5f,      0.25f, 0.5f,  0.0f,  -1.0f,  0.0f,
		  0.5f, -0.0f,  -0.5f,      0.25f, 0.5f,  0.0f,  -1.0f,  0.0f,
	...
	// Crear el Mesh y agregarlo a la lista de mallas
	Mesh* dado = new Mesh();
	dado->CreateMesh(dado_vertices, dado_indices, 192, 24); // Usamos los índices para crear las caras
	meshList.push_back(dado);
}
